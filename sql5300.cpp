 ...
 *
 *
 * This is NOT the original cheeta version but an updated one provided in
 * one of the _prep tags in Lundeens repo
 *
 */
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char *argv[]) {
    ...
    // TODO FIXME Right now the passing of filepaths is very 'fragile':
    // not all valid paths are recognized
    // would need to do some additional 'clean up' on the string before passing 
